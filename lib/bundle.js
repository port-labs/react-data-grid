...
var css_248z$f = ".cj343x0707{background-color:inherit;border-block-end:1px solid var(--rdg-border-color);border-inline-end:1px solid var(--rdg-border-color);contain:strict;contain:size layout style paint;grid-row-start:var(--rdg-grid-row-start);outline:none;overflow:hidden;overflow:clip;padding-block:0;padding-inline:8px;text-overflow:ellipsis;white-space:nowrap}.cj343x0707[aria-selected=true]{outline:2px solid var(--rdg-selection-color);outline-offset:-2px}.csofj7r707 .cj343x0707{contain:content}.ch2wcw8707{position:sticky;z-index:1}.c1wvphzh707{box-shadow:calc(2px*var(--rdg-sign)) 0 5px -2px hsla(0,0%,53%,.3)}";
styleInject(css_248z$f,{"insertAt":"top"});

const cell = "cj343x0707";
const cellClassname = `rdg-cell ${cell}`;
const cellAutoResizeClassname = "csofj7r707";
const cellFrozen = "ch2wcw8707";
const cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
const cellFrozenLast = "c1wvphzh707";
const cellFrozenLastClassname = `rdg-cell-frozen-last ${cellFrozenLast}`;

var css_248z$e = ".rnvodz5707{--rdg-color:#000;--rdg-border-color:#ddd;--rdg-summary-border-color:#aaa;--rdg-background-color:#fff;--rdg-header-background-color:#f9f9f9;--rdg-row-hover-background-color:#f5f5f5;--rdg-row-selected-background-color:#dbecfa;--row-selected-hover-background-color:#c9e3f8;--rdg-checkbox-color:#005194;--rdg-checkbox-focus-color:#61b8ff;--rdg-checkbox-disabled-border-color:#ccc;--rdg-checkbox-disabled-background-color:#ddd;--rdg-selection-color:#66afe9;--rdg-font-size:14px;background-color:var(--rdg-background-color);block-size:350px;border:1px solid var(--rdg-border-color);box-sizing:border-box;color:var(--rdg-color);color-scheme:var(--rdg-color-scheme,light dark);contain:strict;contain:size layout style paint;content-visibility:auto;display:grid;font-size:var(--rdg-font-size);overflow:auto;user-select:none}@supports not (contain:strict){.rnvodz5707{position:relative;z-index:0}}.rnvodz5707 *,.rnvodz5707 :after,.rnvodz5707 :before{box-sizing:inherit}.rnvodz5707:before{content:\"\";grid-column:1/-1;grid-row:1/-1}.rnvodz5707.rdg-dark{--rdg-color-scheme:dark;--rdg-color:#ddd;--rdg-border-color:#444;--rdg-summary-border-color:#555;--rdg-background-color:#212121;--rdg-header-background-color:#1b1b1b;--rdg-row-hover-background-color:#171717;--rdg-row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--rdg-checkbox-color:#94cfff;--rdg-checkbox-focus-color:#c7e6ff;--rdg-checkbox-disabled-border-color:#000;--rdg-checkbox-disabled-background-color:#333}.rnvodz5707.rdg-light{--rdg-color-scheme:light}@media (prefers-color-scheme:dark){.rnvodz5707:not(.rdg-light){--rdg-color:#ddd;--rdg-border-color:#444;--rdg-summary-border-color:#555;--rdg-background-color:#212121;--rdg-header-background-color:#1b1b1b;--rdg-row-hover-background-color:#171717;--rdg-row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--rdg-checkbox-color:#94cfff;--rdg-checkbox-focus-color:#c7e6ff;--rdg-checkbox-disabled-border-color:#000;--rdg-checkbox-disabled-background-color:#333}}.vlqv91k707.r1upfr80707{cursor:move}.f1lsfrzw707{grid-column:1/-1;pointer-events:none;z-index:4}";
styleInject(css_248z$e,{"insertAt":"top"});

const root = "rnvodz5707";
const rootClassname = `rdg ${root}`;
const viewportDragging = "vlqv91k707";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
const focusSinkClassname = "f1lsfrzw707";

var css_248z$d = ".r1upfr80707{background-color:var(--rdg-background-color);display:contents;line-height:var(--rdg-row-height)}.r1upfr80707:hover{background-color:var(--rdg-row-hover-background-color)}.r1upfr80707[aria-selected=true]{background-color:var(--rdg-row-selected-background-color)}.r1upfr80707[aria-selected=true]:hover{background-color:var(--row-selected-hover-background-color)}.r190mhd3707{outline:2px solid var(--rdg-selection-color);outline-offset:-2px}.r139qu9m707:before{border-inline-start:2px solid var(--rdg-selection-color);content:\"\";display:inline-block;height:100%;inset-inline-start:0;position:sticky}";
styleInject(css_248z$d,{"insertAt":"top"});

const row = "r1upfr80707";
const rowClassname = `rdg-row ${row}`;
const rowSelected = "r190mhd3707";
const rowSelectedClassname = `rdg-row-selected`;
const rowSelectedWithFrozenCell = "r139qu9m707";

var css_248z$c = ".c2xai5k707{align-items:center;cursor:pointer;display:flex;inset:0;justify-content:center;margin-inline-end:1px;position:absolute}.c1nhzyev707{all:unset}.cdhtjkm707{background-color:var(--rdg-background-color);block-size:20px;border:2px solid var(--rdg-border-color);content:\"\";inline-size:20px}.c1nhzyev707:checked+.cdhtjkm707{background-color:var(--rdg-checkbox-color);outline:4px solid var(--rdg-background-color);outline-offset:-6px}.c1nhzyev707:focus+.cdhtjkm707{border-color:var(--rdg-checkbox-focus-color)}.cy65rq2707{cursor:default}.cy65rq2707 .cdhtjkm707{background-color:var(--rdg-checkbox-disabled-background-color);border-color:var(--rdg-checkbox-disabled-border-color)}";
styleInject(css_248z$c,{"insertAt":"top"});

const checkboxLabel = "c2xai5k707";
const checkboxLabelClassname = `rdg-checkbox-label ${checkboxLabel}`;
const checkboxInput = "c1nhzyev707";
const checkboxInputClassname = `rdg-checkbox-input ${checkboxInput}`;
const checkbox = "cdhtjkm707";
const checkboxClassname = `rdg-checkbox ${checkbox}`;
const checkboxLabelDisabled = "cy65rq2707";
...
var css_248z$b = ".g1vzro7t707{outline:none}.c1fsqdic707{stroke:currentColor;stroke-width:1.5px;fill:transparent;margin-inline-start:4px;vertical-align:middle}.c1fsqdic707>path{transition:d .1s}";
styleInject(css_248z$b,{"insertAt":"top"});

const groupCellContent = "g1vzro7t707";
const groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
const caret = "c1fsqdic707";
...
function getCellClassname(column, ...extraClasses) {
  return clsx(cellClassname, ...extraClasses, column.frozen && cellFrozenClassname, column.isLastFrozenColumn && cellFrozenLastClassname, column.key === 'FROZEN_RIGHT_COLUMN' && 'RIGHT_COLUMN_FROZEN_CLASS');
}
  ...
  return useMemo(() => {
    ...
    if (!viewportColumns.find(i => i.key === 'FROZEN_RIGHT_COLUMN') && columns.find(i => i.key === 'FROZEN_RIGHT_COLUMN')) {
      viewportColumns.push({
        ...
        cellClass: 'RIGHT_COLUMN_FROZEN_CLASS'
      });
    }
...
var css_248z$a = ".h1af91pe707{cursor:pointer;display:flex}.h1af91pe707:focus{outline:none}.hifiwer707{flex-grow:1;overflow:hidden;overflow:clip;text-overflow:ellipsis}";
styleInject(css_248z$a,{"insertAt":"top"});

const headerSortCell = "h1af91pe707";
const headerSortCellClassname = `rdg-header-sort-cell ${headerSortCell}`;
const headerSortName = "hifiwer707";
...
var css_248z$9 = ".c6l2wv1707{touch-action:none}.c6l2wv1707:after{background:transparent;content:\"\";inline-size:4px;inset-block-end:0;inset-block-start:0;inset-inline-end:0;position:absolute}.c6l2wv1707:active{cursor:url(\"data:image/svg+xml;charset=utf-8,%3Csvg width='20' height='20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M8.531 2.074a.621.621 0 0 0-.613.633v14.586a.621.621 0 0 0 .937.547.633.633 0 0 0 .313-.547V2.707a.639.639 0 0 0-.184-.449.622.622 0 0 0-.453-.184Zm2.918 0a.627.627 0 0 0-.617.633v14.586c0 .223.117.434.313.547a.624.624 0 0 0 .937-.547V2.707a.607.607 0 0 0-.184-.449.607.607 0 0 0-.449-.184ZM3.953 7.078a.621.621 0 0 0-.438 1.07L4.95 9.583H1.457a.633.633 0 0 0-.547.313.624.624 0 0 0 .547.937h3.492l-1.433 1.434a.625.625 0 1 0 .883.883l2.5-2.5a.62.62 0 0 0 0-.883l-2.5-2.5a.617.617 0 0 0-.446-.188Zm12.078 0a.613.613 0 0 0-.43.188l-2.5 2.5a.62.62 0 0 0 0 .883l2.5 2.5c.157.164.387.23.606.171a.625.625 0 0 0 .277-1.054l-1.433-1.434h3.492a.62.62 0 0 0 .547-.937.633.633 0 0 0-.547-.313h-3.492l1.433-1.433a.631.631 0 0 0 .141-.692.632.632 0 0 0-.594-.379Z' fill='%23000'/%3E%3C/svg%3E\") 10 10,auto}.c1kqdw7y707{touch-action:none}.c1kqdw7y707:after{background:#3ed0dd;content:\"\";cursor:url(\"data:image/svg+xml;charset=utf-8,%3Csvg width='20' height='20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M8.531 2.074a.621.621 0 0 0-.613.633v14.586a.621.621 0 0 0 .937.547.633.633 0 0 0 .313-.547V2.707a.639.639 0 0 0-.184-.449.622.622 0 0 0-.453-.184Zm2.918 0a.627.627 0 0 0-.617.633v14.586c0 .223.117.434.313.547a.624.624 0 0 0 .937-.547V2.707a.607.607 0 0 0-.184-.449.607.607 0 0 0-.449-.184ZM3.953 7.078a.621.621 0 0 0-.438 1.07L4.95 9.583H1.457a.633.633 0 0 0-.547.313.624.624 0 0 0 .547.937h3.492l-1.433 1.434a.625.625 0 1 0 .883.883l2.5-2.5a.62.62 0 0 0 0-.883l-2.5-2.5a.617.617 0 0 0-.446-.188Zm12.078 0a.613.613 0 0 0-.43.188l-2.5 2.5a.62.62 0 0 0 0 .883l2.5 2.5c.157.164.387.23.606.171a.625.625 0 0 0 .277-1.054l-1.433-1.434h3.492a.62.62 0 0 0 .547-.937.633.633 0 0 0-.547-.313h-3.492l1.433-1.433a.631.631 0 0 0 .141-.692.632.632 0 0 0-.594-.379Z' fill='%23000'/%3E%3C/svg%3E\") 10 10,auto;inline-size:4px;inset-block-end:0;inset-block-start:0;inset-inline-end:0;position:absolute;transition:.3s}.c1kqdw7y707:active{cursor:url(\"data:image/svg+xml;charset=utf-8,%3Csvg width='20' height='20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M8.531 2.074a.621.621 0 0 0-.613.633v14.586a.621.621 0 0 0 .937.547.633.633 0 0 0 .313-.547V2.707a.639.639 0 0 0-.184-.449.622.622 0 0 0-.453-.184Zm2.918 0a.627.627 0 0 0-.617.633v14.586c0 .223.117.434.313.547a.624.624 0 0 0 .937-.547V2.707a.607.607 0 0 0-.184-.449.607.607 0 0 0-.449-.184ZM3.953 7.078a.621.621 0 0 0-.438 1.07L4.95 9.583H1.457a.633.633 0 0 0-.547.313.624.624 0 0 0 .547.937h3.492l-1.433 1.434a.625.625 0 1 0 .883.883l2.5-2.5a.62.62 0 0 0 0-.883l-2.5-2.5a.617.617 0 0 0-.446-.188Zm12.078 0a.613.613 0 0 0-.43.188l-2.5 2.5a.62.62 0 0 0 0 .883l2.5 2.5c.157.164.387.23.606.171a.625.625 0 0 0 .277-1.054l-1.433-1.434h3.492a.62.62 0 0 0 .547-.937.633.633 0 0 0-.547-.313h-3.492l1.433-1.433a.631.631 0 0 0 .141-.692.632.632 0 0 0-.594-.379Z' fill='%23000'/%3E%3C/svg%3E\") 10 10,auto}";
styleInject(css_248z$9,{"insertAt":"top"});

const cellResizable = "c6l2wv1707";
const cellResizableHovered = "c1kqdw7y707";
...
function HeaderCell({
  ...
  const className = getCellClassname(column, column.headerCellClass, column.resizable && cellResizableClassname, resizeHovered && cellResizableClassnameHovered);
...
var css_248z$8 = ".h10tskcx707{background-color:var(--rdg-header-background-color);display:contents;font-weight:700;line-height:var(--rdg-header-row-height)}.h10tskcx707>.cj343x0707{inset-block-start:0;position:sticky;z-index:2}.h10tskcx707>.ch2wcw8707{z-index:3}";
styleInject(css_248z$8,{"insertAt":"top"});

const headerRow = "h10tskcx707";
...
var css_248z$7 = ".c6ra8a3707,.cq910m0707{background-color:#ccf}.cq910m0707.c6ra8a3707{background-color:#99f}";
styleInject(css_248z$7,{"insertAt":"top"});

const cellCopied = "c6ra8a3707";
const cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
const cellDraggedOver = "cq910m0707";
...
var css_248z$6 = ".g1yxluv3707:not([aria-selected=true]){background-color:var(--rdg-header-background-color)}.g1yxluv3707>.cj343x0707:not(:last-child):not(.c1wvphzh707){border-inline-end:none}";
styleInject(css_248z$6,{"insertAt":"top"});

const groupRow = "g1yxluv3707";
...
var css_248z$5 = ".s8wc6fl707{inset-block-end:var(--rdg-summary-row-bottom);inset-block-start:var(--rdg-summary-row-top)}";
styleInject(css_248z$5,{"insertAt":"top"});

const summaryCellClassname = "s8wc6fl707";
...
var css_248z$4 = ".skuhp55707.r1upfr80707{line-height:var(--rdg-summary-row-height)}.skuhp55707.r1upfr80707>.cj343x0707{position:sticky}.sf8l5ub707>.cj343x0707{border-block-start:2px solid var(--rdg-summary-border-color)}";
styleInject(css_248z$4,{"insertAt":"top"});

const summaryRow = "skuhp55707";
const summaryRowBorderClassname = "sf8l5ub707";
...
var css_248z$3 = ".cis5rrm707.rdg-cell{padding:0}";
styleInject(css_248z$3,{"insertAt":"top"});

const cellEditing = "cis5rrm707";
function EditCell({
  column,
  colSpan,
  row,
...
var css_248z$2 = ".c1w9bbhr707{background-color:var(--rdg-selection-color);block-size:8px;cursor:move;inline-size:8px;inset-block-end:0;inset-inline-end:0;position:absolute}.c1w9bbhr707:hover{background-color:var(--rdg-background-color);block-size:16px;border:2px solid var(--rdg-selection-color);inline-size:16px}";
styleInject(css_248z$2,{"insertAt":"top"});

const cellDragHandle = "c1w9bbhr707";
...
var css_248z$1 = ".a3cv93f707{fill:currentColor}.a3cv93f707>path{transition:d .1s}";
styleInject(css_248z$1,{"insertAt":"top"});

const arrow = "a3cv93f707";
...
function DataGrid({
  ...
  const handleColumnResize = useCallback((column, width) => {
    ...
    gridRef.current.querySelectorAll(`[role="gridcell"][aria-colindex="${column.idx + 1}"]`).forEach(el => {
  ...
  const onLostResize = () => {
    gridRef.current.querySelectorAll(`[role="gridcell"]`).forEach(el => {
...
var css_248z = ".t1u15qzo707{appearance:none;background-color:var(--rdg-background-color);block-size:100%;border:2px solid #ccc;box-sizing:border-box;color:var(--rdg-color);font-family:inherit;font-size:var(--rdg-font-size);inline-size:100%;padding-block:0;padding-inline:6px;vertical-align:top}.t1u15qzo707:focus{border-color:var(--rdg-selection-color);outline:none}.t1u15qzo707::placeholder{color:#999;opacity:1}";
styleInject(css_248z,{"insertAt":"top"});

const textEditor = "t1u15qzo707";
